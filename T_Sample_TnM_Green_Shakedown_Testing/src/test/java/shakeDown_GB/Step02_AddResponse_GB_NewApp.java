...
public class Step02_AddResponse_GB_NewApp
{
	...
	// Define the element 
		...
		@FindBy ( xpath = "//a[contains(text(),'T232NX')]" ) private WebElement RequestId ;
	...
	public Step02_AddResponse_GB_NewApp (WebDriver driver)
	{
		this.driver=driver;
	...
	public void FillRespdetails(String First_Name_temp , String Middle_Name_temp , String LastName_Surname_temp, String rate) throws IOException, InterruptedException 
	{
		...
		js.executeScript("document.getElementById('citizenShip').value='united Kingdom'");*/
		Citizenship_Field.sendKeys("united Kingdom");
